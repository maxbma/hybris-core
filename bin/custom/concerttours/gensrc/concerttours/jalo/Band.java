 ...
 * --- Generated at 15 окт. 2021 г., 15:48:07                   ---
 * ----------------------------------------------------------------
 */
...
public class Band extends GenericItem
{
	...
	/** Qualifier of the <code>Band.visitedCountries</code> attribute **/
	public static final String VISITEDCOUNTRIES = "visitedCountries";
	...
	**/
	...
	static
	{
		...
		tmp.put(VISITEDCOUNTRIES, AttributeMode.INITIAL);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Band.visitedCountries</code> attribute.
	 * @return the visitedCountries - Set of visited by band countries
	 */
	public Set<String> getVisitedCountries(final SessionContext ctx)
	{
		Set<String> coll = (Set<String>)getProperty( ctx, "visitedCountries".intern());
	...
	{
		return getVisitedCountries( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>Band.visitedCountries</code> attribute. 
	 * @param value the visitedCountries - Set of visited by band countries
	 */
	public void setVisitedCountries(final SessionContext ctx, final Set<String> value)
	{
		setProperty(ctx, "visitedCountries".intern(),value == null || !value.isEmpty() ? value : null );
	}
	 ...
	 * @param value the visitedCountries - Set of visited by band countries
	 */
	public void setVisitedCountries(final Set<String> value)
	{
		setVisitedCountries( getSession().getSessionContext(), value );
	}
