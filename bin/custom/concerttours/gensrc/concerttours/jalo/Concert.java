...
public class Concert extends VariantProduct
{
	 ...
	 * @return the bands - bands that will perform at a concert
	 */
	public Map<String,Band> getAllBands(final SessionContext ctx)
	{
		Map<String,Band> map = (Map<String,Band>)getProperty( ctx, "bands".intern());
	 ...
	 * @return the bands - bands that will perform at a concert
	 */
	public Map<String,Band> getAllBands()
	{
		return getAllBands( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>Concert.bands</code> attribute. 
	 * @param value the bands - bands that will perform at a concert
	 */
	public void setAllBands(final SessionContext ctx, final Map<String,Band> value)
	{
		setProperty(ctx, "bands".intern(),value);
	}
	 ...
	 * @param value the bands - bands that will perform at a concert
	 */
	public void setAllBands(final Map<String,Band> value)
	{
		setAllBands( getSession().getSessionContext(), value );
	}
